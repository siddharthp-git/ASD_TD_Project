"""
train.py – DV-STTGAT  (NYU-only, SOTA v3, CC400 atlas)
=======================================================
End-to-end training pipeline for the Dual-View Spatio-Temporal Graph
Attention Transformer (DV-STTGAT), restricted to NYU-site subjects only.
...
Pipeline
--------
1. Load cached CC400 BOLD signals (NYU subjects, from cc400_bold_cache/)
...
def save_results_to_txt(
    ...
    lines = []
    lines.append(sep)
    lines.append("  DV-STTGAT — NYU-only | CC400 Full-Brain | Cross-Validation Results")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="DV-STTGAT Trainer (NYU-only, 5-Fold CV)")
    parser.add_argument(
    ...
    print("  *** NYU-ONLY  │  SOTA v3  │  CC400 Full-Brain (~392 ROIs)  │  5-Fold CV ***")
    print("=" * 70)
    ...
    print("\nStep 1 – Loading NYU BOLD signals from bold_cache …")
