"""
tune.py – Optuna Hyperparameter Tuning for DV-STTGAT (Age 6-11, All sites, CC400)
=======================================================================
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Optuna hyperparameter tuning for DV-STTGAT (Age 6-11, All sites, CC400)"
    )
    ...
    print("=" * 70)
    print("  DV-STTGAT — Optuna Hyperparameter Tuning  (Age 6-11 | All sites | CC400)")
