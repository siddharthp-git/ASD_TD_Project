"""
ensemble_eval.py – DV-STTGAT  (NYU-only)
==========================================
Loads all 5 fold checkpoints, runs every NYU subject through each model,
soft-votes the probability scores, and reports a single unified
Accuracy, Sensitivity, Specificity and AUC for the full NYU dataset.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="DV-STTGAT Ensemble Evaluator (NYU)")
    ...
    print("=" * 70)
    print("  DV-STTGAT — Ensemble Evaluation  (NYU, 5-Fold Soft Voting)")
    print("=" * 70)
    ...
    print("\nStep 1 – Loading NYU BOLD signals …")
    ...
    print("\n" + "=" * 70)
    print("  ENSEMBLE RESULTS  (5-Model Soft Voting, Full NYU Dataset)")
    print("=" * 70)
