"""
train.py – DV-STTGAT  (Age 6-11, All sites, SOTA v3, CC400 atlas)
=======================================================
End-to-end training pipeline for the Dual-View Spatio-Temporal Graph
Attention Transformer (DV-STTGAT), restricted to subjects aged 6-11 across all sites.
...
Pipeline
--------
1. Load cached CC400 BOLD signals (Age 6-11 subjects, from cc400_bold_cache/)
...
def save_results_to_txt(
    ...
    lines = []
    lines.append(sep)
    lines.append("  DV-STTGAT — Age 6-11 | CC400 Full-Brain | Cross-Validation Results")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="DV-STTGAT Trainer (Age 6-11, All sites, 5-Fold CV)")
    parser.add_argument(
    ...
    print("  *** AGE 6-11 (ALL SITES)  │  SOTA v3  │  CC400 Full-Brain (~392 ROIs)  │  5-Fold CV ***")
    print("=" * 70)
    ...
    print("\nStep 1 – Loading Age 6-11 BOLD signals from bold_cache …")
